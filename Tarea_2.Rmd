...
pacman::p_load(tidyverse,
               ...
               knitr, tinytex, reshape, lubridate, scales, reshape2, seasonal, plm)
...
boxplot(df_e, xlab="Personas", ylab="Errores")
...
LR
plot(panel_data$Y, panel_data$C, main= "Relación Consumo~Ingreso",
   xlab="Ingreso Total", ylab="Consumo",pch=19)
abline(lm(C~Y, data=panel_data), col="red")
...
LR2
plot(panel_data2$Y, panel_data2$C, main= "Relación Consumo~Ingreso",
   xlab="Ingreso Total", ylab="Consumo",pch=19)
abline(lm(C~Y, data=panel_data2), col="blue")
```
...
LR3
plot(panel_data3$Y, panel_data3$C, main= "Relación Consumo~Ingreso",
   xlab="Ingreso Total", ylab="Consumo",pch=19)
abline(lm(C~Y, data=panel_data3), col="green")
```

...
```{r echo=FALSE, fig.cap= "Descomposición de la serie G", fig.pos='H'}
...
```{r       echo=FALSE,fig.cap= "Variables macroeconómicas seleccionadas", fig.pos='H',warning=FALSE       }
## Todas juntas:
unidas<-ts.union(cst,yst,Ist,grstd,xnst)
plot(unidas,xlab="Tiempo",main="")
```
...
```{r    echo=FALSE, fig.cap= "Variables seleccionadas: 1993-2022", fig.pos='H'}
juntas<-ts.union(cst,yst,Ist,grstd,dframe=FALSE)
plot(juntas, ylab="CYIG",xlab="Tiempo",main="")
```
...
```{r echo=FALSE,                                   include=TRUE, fig.cap= "Variables seleccionadas en logaritmo: 1993-2022", fig.pos='H'}
plot(lnjuntas,ylab="LogX",xlab="Tiempo",main="")
```
...
```{r echo=FALSE, fig.cap= "Variaciones porcentuales de variables seleccionadas: 1993-2022", fig.pos='H',warning=FALSE}
...
```{r         echo=FALSE, include=TRUE, fig.cap= "Relación entre %Y y %C", fig.pos='H', warning=FALSE}
## Graficamos Y y C:
...
```{r echo=FALSE,             include=TRUE, fig.cap= "Relación entre ln(Y) y ln(C)", fig.pos='H', warning=FALSE}
##Graficamos
...
```{r  echo=FALSE,          include=TRUE,fig.cap= "Modelo de regresión 1", fig.pos='H', warning=FALSE}
#Modelo 1:
...
```{r  echo=FALSE,                     include=TRUE,fig.cap= "Errores: Modelo de regresión 1", fig.pos='H',warning=FALSE}
...
```{r echo=FALSE, include=TRUE,fig.cap= "Modelo de regresión 2", fig.pos='H', warning=FALSE}
#Modelo 2:
...
```{r  echo=FALSE, fig.cap= "Errores: Modelo de regresión 2", fig.pos='H',warning=FALSE}
## Obtenemos los residuos
...
```{r  echo=FALSE,           include=TRUE,fig.cap= "Modelo de regresión 4", fig.pos='H',warning=FALSE}
#Modelo 4:
...
```{r  echo=FALSE,                     include=TRUE,fig.cap= "Errores: Modelo de regresión 4", fig.pos='H',warning=FALSE}
## Obtenemos los residuos
